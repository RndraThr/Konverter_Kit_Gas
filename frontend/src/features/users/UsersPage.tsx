...
export function UsersPage() {
  ...
  return <div className="page">
    <header className="pageHeader"><div><h1>Pengguna</h1><p>Kelola akun internal dan role untuk akses operasional.</p></div>{canManage && <button className="primaryButton" onClick={() => { save.reset(); setSelected(undefined); setDialogOpen(true); }}><Plus />Tambah pengguna</button>}</header>
