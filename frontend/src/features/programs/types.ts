...
export type Schedule = { id: string; program_id: string; regency_id: string; package_template_version_id: string; documentation_template_version_id: string; name: string; start_date: string; end_date: string; status: string; distribution_number_padding: number; notes?: string; program?: Program; regency?: Regency; package_template?: PackageTemplate; documentation_template?: DocumentationTemplate };
